...
const Experience = () => {
    ...
    return (
        <section id="experience" className="w-full px-5 md:px-6 lg:px-16 py-8 lg:py-24 bg-transparent text-slate-900 border-t border-slate-100">
            ...
            <div className="space-y-10 md:space-y-16">
                {t.list.map((exp, index) => (
                    <motion.div
                        ...
                        className="grid md:grid-cols-2 gap-4 md:gap-8 items-start border-t border-slate-200 pt-6 lg:pt-10"
                    >
                        {/* Left: Role & Company */}
                        <div>
                            <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-1">{exp.role}</h3>
                            <div className="text-lg md:text-xl text-blue-600 font-medium mb-2 md:mb-4">{exp.company}</div>
                            <div className="flex items-center gap-2 text-slate-400 text-xs md:text-sm tracking-widest uppercase font-bold mb-4 md:mb-0">
                                <Calendar size={14} />
                                {exp.period}
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="text-slate-600 text-base md:text-lg leading-relaxed mb-4 md:mb-6">
                                {exp.description}
                            </div>
