            ...
            <div className="w-full px-5 md:px-8 lg:px-16">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="text-center md:text-left">
                        <h3 className="text-xl font-bold mb-2 tracking-tight">Portfolio.</h3>
                        <p className="text-slate-400 text-sm">
                            © {new Date().getFullYear()} Muhammad Azahrul Ramadhan. {t.rights}
                        </p>
                        <a href="/admin/login" className="opacity-10 hover:opacity-50 transition-opacity text-slate-400 inline-flex items-center gap-1 mt-4 text-xs" title="Admin Access">
                    ...
                    <div className="flex items-center gap-6">
                        <SocialLink href="https://www.threads.net/@azhrl_dp" title="Threads">
                            <ThreadsIcon />
                        </SocialLink>
                        <SocialLink href="https://www.instagram.com/azhrl_dp/" title="Instagram">
                            <Instagram className="w-5 h-5" />
                        </SocialLink>
                        <SocialLink href="https://x.com/99_azahrul" title="X (Twitter)">
                            <Twitter className="w-5 h-5" />
                        </SocialLink>
                        <SocialLink href="https://www.facebook.com/muhammad.azahrul.ramadhan" title="Facebook">
                            <Facebook className="w-5 h-5" />
                        </SocialLink>
                        <SocialLink href="http://medium.com/@muhammadazahrulramadhan" title="Medium">
